								...
								<div class="row-fluid">
									<div class="center">
										<h1>
											...
											<span class="red">&nbsp;微信公众平台控制中心</span>
											<span class="white"></span>
											
										</h1>
										<h4 class="blue">&copy; <a href="http://weibo.com/178263961" target="_blank">阿丢丢</a></h4>
									</div>
								</div>
										...
										<div id="login-box" class="login-box visible widget-box no-border">
											<div class="widget-body">
												<div class="widget-main">
														...
														<fieldset>
															<label>
																<span class="block input-icon input-icon-right">
																	<input type="text" class="span12" name="username" <c:if test="${username!=null}">value="${username}"</c:if> required placeholder="Username" />
																	<i class="icon-user"></i>
																</span>
															</label>
															...
															<label>
																<span class="block input-icon input-icon-right">
																	<input type="password" class="span12" name="password" value="" required placeholder="Password" />
																	<i class="icon-lock"></i>
																</span>
															</label>
															...
															<div class="clearfix">
																...
																<button class="btn btn-lg btn-primary btn-block" type="submit" id="login" name="login" ><i class="icon-key"></i>登录</button>
															</div>
													...
													<span class="bigger-110">南通斯柯达(ntskoda)</span>
													</div>
													
													<div class="social-login center">
														<img alt="南通斯柯达" src="<%=request.getContextPath()%>/assets/images/getqrcode.jpg" style="height: 100px;width: 100px;" >
													</div>
